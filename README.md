## Trail Coding Exercise

Your objective is to implement and improve the interface in the wireframe below in any
way you like.

The file `games.json` contains the data pertaining to each game.

*The only requirement is that the layout is responsive.* Apart from that, it's a very open exercise. Feel free to make any improvements you see fit.

Possible improvements include:
  * Implement using your favorite JS framework, or try a new one
  * Add some style, preferably without integrating an entire CSS framework like bootstrap
  * Add CSS animations (loading spinner, fade/slide in games, etc.)
  * Display a detail view of the games when clicking on them
  * Fade in cover art when loaded, using `game.img_card_avg_color` as a placeholder
  * Filtering and/or sorting of games (by tags, players online, rating, etc.)
  * Utilize any other data available for each game in `games.json`
  
  
  ![Wireframe](https://i.imgur.com/8snYGUY.png)
